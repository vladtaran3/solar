$(function(){
    ...
    $('.rate__body-link').on('click', function (e) {
        e.preventDefault();

    $('.rate__body-link').removeClass('rate__body-link--active');
    $(this).addClass('rate__body-link--active');

    $('.rate__body-column').removeClass('rate__body-column--active');
    $($(this).attr('href')).addClass('rate__body-column--active');
